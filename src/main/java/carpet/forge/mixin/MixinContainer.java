...
public abstract class MixinContainer {
    ...
    @Shadow public abstract ItemStack transferStackInSlot(EntityPlayer playerIn, int index);
                ...
                if (slot6 != null) {
                    ...
                    if (itemstack8.isEmpty()) {
                        ...
                        if (itemstack11.isEmpty()) {
                            ...
                            // [FCM] Check If item can stack, Always true in vanilla
                            if (itemstack8.getItem() == itemstack11.getItem() && itemstack8.getMetadata() == itemstack11.getMetadata() && ItemStack.areItemStackTagsEqual(itemstack8, itemstack11) && itemstack11.isStackable()) {
            ...
            if (!itemstack6.isEmpty() || !itemstack10.isEmpty()) {
                if (itemstack6.isEmpty()) {
                    if (slot4.canTakeStack(player)) {
                        ...
                        ((IMixinSlot) slot4).invokeOnSwapCraft(itemstack10.getCount());
