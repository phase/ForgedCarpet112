...
public class CommandRNG extends CarpetCommandBase {
            ...
            try {
                ...
                if (gen instanceof ChunkGeneratorOverworld) {
                    ...
                    notifyCommandListener(sender, this,
                            String.format("Seed at chunk coords: %d %d seed: %d", x, z, ((IWorld) world).getRandSeed()));
                }
            } catch (Exception e) {
    ...
    public List<String> getTabCompletions(MinecraftServer server, ICommandSender sender, String[] args,
        ...
        if (args.length >= 2) {
            if ("seed".equalsIgnoreCase(args[0])) {
                ...
                return getTabComplete(args, 1, pos);
            }
    ...
    public static List<String> getTabComplete(String[] inputArgs, int index, @Nullable BlockPos lookedPos) {
        if (lookedPos == null) {
