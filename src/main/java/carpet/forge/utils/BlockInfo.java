...
public class BlockInfo {
    ...
    public static String getSoundName(SoundType stype) {
        if (stype == SoundType.WOOD) {
            return "WOOD";
        }
        if (stype == SoundType.GROUND) {
            return "GRAVEL";
        }
        if (stype == SoundType.PLANT) {
            return "GRASS";
        }
        if (stype == SoundType.STONE) {
            return "STONE";
        }
        if (stype == SoundType.METAL) {
            return "METAL";
        }
        if (stype == SoundType.GLASS) {
            return "GLASS";
        }
        if (stype == SoundType.CLOTH) {
            return "WOOL";
        }
        if (stype == SoundType.SAND) {
            return "SAND";
        }
        if (stype == SoundType.SNOW) {
            return "SNOW";
        }
        if (stype == SoundType.LADDER) {
            return "LADDER";
        }
        if (stype == SoundType.ANVIL) {
            return "ANVIL";
        }
        if (stype == SoundType.SLIME) {
            return "SLIME";
        }
    ...
    private static String getMapColourName(MapColor colour) {
        ...
        if (colour == MapColor.SAND) {
            return "SAND";
        }
        if (colour == MapColor.CLOTH) {
            return "WOOL";
        }
        if (colour == MapColor.TNT) {
            return "TNT";
        }
        if (colour == MapColor.ICE) {
            return "ICE";
        }
        if (colour == MapColor.IRON) {
            return "IRON";
        }
        if (colour == MapColor.FOLIAGE) {
            return "FOLIAGE";
        }
        if (colour == MapColor.SNOW) {
            return "SNOW";
        }
        if (colour == MapColor.CLAY) {
            return "CLAY";
        }
        if (colour == MapColor.DIRT) {
            return "DIRT";
        }
        if (colour == MapColor.STONE) {
            return "STONE";
        }
        if (colour == MapColor.WATER) {
            return "WATER";
        }
        if (colour == MapColor.WOOD) {
            return "WOOD";
        }
        if (colour == MapColor.QUARTZ) {
            return "QUARTZ";
        }
        if (colour == MapColor.ADOBE) {
            return "ADOBE";
        }
        if (colour == MapColor.MAGENTA) {
            return "MAGENTA";
        }
        if (colour == MapColor.LIGHT_BLUE) {
            return "LIGHT_BLUE";
        }
        if (colour == MapColor.YELLOW) {
            return "YELLOW";
        }
        if (colour == MapColor.LIME) {
            return "LIME";
        }
        if (colour == MapColor.PINK) {
            return "PINK";
        }
        if (colour == MapColor.GRAY) {
            return "GRAY";
        }
        if (colour == MapColor.SILVER) {
            return "SILVER";
        }
        if (colour == MapColor.CYAN) {
            return "CYAN";
        }
        if (colour == MapColor.PURPLE) {
            return "PURPLE";
        }
        if (colour == MapColor.BLUE) {
            return "BLUE";
        }
        if (colour == MapColor.BROWN) {
            return "BROWN";
        }
        if (colour == MapColor.GREEN) {
            return "GREEN";
        }
        if (colour == MapColor.RED) {
            return "RED";
        }
        if (colour == MapColor.BLACK) {
            return "BLACK";
        }
        if (colour == MapColor.GOLD) {
            return "GOLD";
        }
        if (colour == MapColor.DIAMOND) {
            return "DIAMOND";
        }
        if (colour == MapColor.LAPIS) {
            return "LAPIS";
        }
        if (colour == MapColor.EMERALD) {
            return "EMERALD";
        }
        if (colour == MapColor.OBSIDIAN) {
            return "OBSIDIAN";
        }
        if (colour == MapColor.NETHERRACK) {
            return "NETHERRACK";
        }
        return "Something new";
    }
